...
The firmware is the same for AD9914 and AD9915 except for the inscription on the OLED screen, you need to change line 14 in the DisplayMenu.ino file to display.printin(F("DDS AD9915")); <br/>
Link for repository: <a href="https://github.com/afch/DDS-AD9914-Arduino-Shield"> Analog Devices AD9914 Arduino Shield </a> <br/>
